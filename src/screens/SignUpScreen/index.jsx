...
import { SafeAreaView, View, Text, ScrollView, StatusBar, Keyboard } from 'react-native'
            ...
            {({ handleChange, handleBlur, handleSubmit, values, errors }) => (
              <>
                ...
                <View style={{ marginTop: 15 }}>
                  ...
                  >
                    <View style={{ width: "50%", backgroundColor: theme.colors.BACKGROUND, borderRadius: 15 }}>
                      <Text style={{
                        textAlign: "center",
                    ...
                    <View style={{ width: "50%", backgroundColor: theme.colors.SHAPE, borderRadius: 15 }}>
                      <Text style={{
                        textAlign: "center",
                        fontFamily: theme.fonts.REGULAR,
                        color: theme.colors.TEXT,
